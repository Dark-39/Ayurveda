  ...
  return (
    <header className="bg-gradient-to-br from-purple-900 via-indigo-900 to-blue-900 text-white px-6 py-8 mb-8 relative overflow-hidden">
      ...
      <div className="relative flex items-center justify-center">
        <Sparkles size={32} className="mr-4 text-purple-300" />
        <h1 className="text-3xl font-bold bg-gradient-to-r from-white to-purple-200 bg-clip-text text-transparent">{title}</h1>
      </div>
    </header>
  );
};
